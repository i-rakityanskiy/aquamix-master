  ...
  return (
    <div className="min-h-screen flex flex-col items-center p-4 md:p-8">
      ...
      <main className="w-full max-w-md space-y-6">
        ...
        {/* Results Card */}
        <section className={`rounded-3xl p-6 shadow-2xl transition-all duration-300 ${results.isValid ? 'bg-indigo-600 text-white' : 'bg-red-50 text-red-600 border border-red-200'}`}>
          {!results.isValid ? (
            ...
            <div className="space-y-6">
              <div className="flex justify-between items-end">
                <div>
                  ...
                  <p className="text-3xl font-black">Recipe Found</p>
                </div>
                <div className="text-right">
                  <span className="block text-xs opacity-75">Target</span>
                  <span className="text-lg font-bold">{settings.targetVolume}ml @ {settings.targetTemp}°C</span>
                </div>
              </div>
        ...
        <footer className="text-center pb-8 pt-4">
          <p className="text-xs text-slate-400 font-medium">
            Remember: Always check temperature manually before use, especially for baby care.
          </p>
        </footer>
      </main>
    </div>
